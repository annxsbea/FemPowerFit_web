    ...
    <div id="services" className="min-h-screen flex-col items-center ">
      ...
      <div className="flex justify-center items-center space-x-16">
        ...
        <div className="mt-36">
          ...
          <div className="border border-red-300 px-10 rounded-lg h-40 w-60 p-8 mt-10  transition-all hover:scale-105 duration-150 ease-linear">
        ...
        <div className="mt-32">
          ...
          <div className="border border-red-300 px-10 rounded-lg h-40 w-72 p-8   mt-10 transition-all hover:scale-105 duration-150 ease-linear">
        ...
        <div className="mt-36">
          ...
          <div className="border border-red-300 px-10 rounded-lg h-48 w-64 p-5 mt-10 transition-all hover:scale-105 duration-150 ease-linear">
            <p className="text-sm">Frustração com a falta de plataformas holísticas que integram treino, </p>
            <p className="text-sm">
              alimentação e suplementação específicos para as necessidades femininas</p>
          </div>
        </div>
